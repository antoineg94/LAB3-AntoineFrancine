...
                float tempsTotalniv2 = _tempsNiveau2 + _accrochagesNiveau2; // Calcul le temps total pour le niveau 2
                ...
                int _accrochagesNiveau3 = _gestionJeu.GetPointage() - (_gestionJeu.GetAccrochagesNiv2() + _gestionJeu.GetAccrochagesNiv1()); // Calcul le nombre d'accrochages pour le niveau 2
